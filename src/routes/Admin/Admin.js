...
const Admin = (props) => {
  ...
  const [data, setData] = useState([
    {
      ...
      name: 'McDouble',
      price: '$13.45',
      image_link: 'https://www.mcdonalds.com/content/dam/usa/nfl/nutrition/items/regular/desktop/t-mcdonalds-McDouble.jpg',
    },
    {
      id: '001',
      name: 'McDouble',
  ...
  const switchContent = () => {
    switch (selectedTable) {
          ...
          <>
              <div>
                ...
                {data.length > 0 ? (
                  <div>
                    <div
                      className={classes.tabblecontainer}
                    >
                      <StickyTable>
                        <Row>
                          <Cell></Cell>
                          {data[0]
                            ? getColumnsFromTable(selectedTable, data)?.map((x) => (
                                <Cell>
      ...
      default:
        return (
          <div className={classes.emptystate}>Select From Sidebar</div>
        )
    }
  }
